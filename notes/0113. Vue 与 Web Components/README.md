...
- [3. 🤔 在 Vue 应用里使用自定义元素时，最容易踩哪些坑？](#3--在-vue-应用里使用自定义元素时最容易踩哪些坑)
  - [3.1. 要显式跳过组件解析](#31-要显式跳过组件解析)
  - [3.2. 复杂数据通常应该走 DOM property](#32-复杂数据通常应该走-dom-property)
- [4. 🤔 怎样用 Vue 自己来构建 Web Components？](#4--怎样用-vue-自己来构建-web-components)
  - [4.1. `defineCustomElement`](#41-definecustomelement)
  - [4.2. 生命周期、props、事件和插槽](#42-生命周期props事件和插槽)
  - [4.3. `.ce.vue` 和样式注入](#43-cevue-和样式注入)
- [5. 🤔 TypeScript、组件库发布和跨框架复用要注意什么？](#5--typescript组件库发布和跨框架复用要注意什么)
  - [5.1. TypeScript 类型支持](#51-typescript-类型支持)
  - [5.2. 组件库发布](#52-组件库发布)
