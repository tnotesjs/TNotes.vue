---
id: 1b950d1b-5954-4cf9-9b46-04ad6f100ea7
description: 介绍了本地集成 Vue 的两种方式：CDN、NPM 包，以及 Vue 官方推荐的一些线上体验 Vue 的做法。
---
...
<html lang="en">
  ...
  <body>
    ...
    <script src="https://unpkg.com/vue@3/dist/vue.global.js"></script>
    <script>
      // 使用 CDN 引入后，Vue 会被注册为一个全局变量，可以直接使用：
      const { createApp, ref } = Vue
