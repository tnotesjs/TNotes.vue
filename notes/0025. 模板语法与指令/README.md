...
以 `v-on:submit.prevent="onSubmit"` 为例，其中：
...
::: tip Vue 官方文档中提供的指令语法结构图

![img](https://cdn.jsdelivr.net/gh/tnotesjs/imgs-2026@main/2026-04-29-08-00-23.png)
