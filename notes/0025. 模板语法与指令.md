---
id: e2030fad-a1a4-4651-a881-226c5f7c924e
description: 模板语法和指令是开发 Vue 组件必备的基础知识点。
---
...
在本节介绍的知识点中，「`{{ }}` 语法」、「常用内置指令」、「Class 与 Style 绑定」是 Vue 模板中最基础也是最常用的特性，可以说是开发 Vue 组件必备的知识点，也是使用频率极高的知识点。
