---
id: 6b9430de-b854-46fa-a32d-59f7e2ed79a1
description: Vue 生命周期介绍，包括创建、挂载、更新和卸载阶段的钩子函数使用场景和相关注意事项。
---
...
<template>
  <button @click="isVisible = !isVisible">
    切换组件显示/隐藏，测试 unmounted
  </button>
  <TestLifeCycle v-if="isVisible" />
</template>

<script setup>
import { ref } from 'vue'
import TestLifeCycle from './TestLifeCycle.vue'

const isVisible = ref(true)
</script>
```

```vue [TestLifeCycle.vue]
<template>
  <p>打开控制台查看打印结果</p>
