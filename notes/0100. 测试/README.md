...
- [5. 官方推荐的测试工具应该怎么选？](#5-官方推荐的测试工具应该怎么选)
  - [5.1. 单元测试](#51-单元测试)
  - [5.2. 组件测试](#52-组件测试)
  - [5.3. Vite 项目里的常见组合](#53-vite-项目里的常见组合)
- [6. 组件测试应该测什么，不该测什么？](#6-组件测试应该测什么不该测什么)
- [7. 组合式函数怎么测，为什么有时要包一个宿主组件？](#7-组合式函数怎么测为什么有时要包一个宿主组件)
  - [7.1. 不依赖组件实例的组合式函数](#71-不依赖组件实例的组合式函数)
  - [7.2. 依赖生命周期或注入的组合式函数](#72-依赖生命周期或注入的组合式函数)
- [8. 什么时候该上 E2E，选 Playwright 还是 Cypress？](#8-什么时候该上-e2e选-playwright-还是-cypress)
  - [8.1. Playwright](#81-playwright)
  - [8.2. Cypress](#82-cypress)
- [9. 引用](#9-引用)
