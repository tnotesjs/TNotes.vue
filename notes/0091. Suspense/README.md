...
- [10. 🤔 异步组件和 `<Suspense>` 是什么关系？](#10--异步组件和-suspense-是什么关系)
  - [10.1. `<Suspense>` 简介](#101-suspense-简介)
  - [10.2. 两者之间的关系](#102-两者之间的关系)
  - [10.3. 配合使用](#103-配合使用)
  - [10.4. 错误处理的最佳实践 - 外层用 `onErrorCaptured` 兜底](#104-错误处理的最佳实践---外层用-onerrorcaptured-兜底)
  - [10.5. 示例：异步组件 `defineAsyncComponent` 与 `<Suspense>` 配合使用](#105-示例异步组件-defineasynccomponent-与-suspense-配合使用)
  - [10.6. 小结](#106-小结)
- [11. 🔗 引用](#11--引用)
...
### 10.4. 错误处理的最佳实践 - 外层用 `onErrorCaptured` 兜底
...
### 10.5. 示例：异步组件 `defineAsyncComponent` 与 `<Suspense>` 配合使用
