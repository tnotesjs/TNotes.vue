...
- [9. 🤔 `<keep-alive>` 是什么？有什么用？](#9--keep-alive-是什么有什么用)
  - [9.1. `<keep-alive>` 简介](#91-keep-alive-简介)
  - [9.2. keep-alive 提供的三个 props：`include`、`exclude`、`max`](#92-keep-alive-提供的三个-propsincludeexcludemax)
  - [9.3. 两个独有的生命周期钩子](#93-两个独有的生命周期钩子)
  - [9.4. 配合 `<component>` 和 Vue Router 使用](#94-配合-component-和-vue-router-使用)
- [10. 🤔 `<component>` 是什么？有什么用？](#10--component-是什么有什么用)
- [11. 💻 demos.1 - `<component>` - 基本用法：标签页切换](#11--demos1---component---基本用法标签页切换)
- [12. 💻 demos.2 - `<component>` - 实现动态 HTML 元素](#12--demos2---component---实现动态-html-元素)
- [13. 💻 demos.3 - `<component>` - 传递 props 和监听事件](#13--demos3---component---传递-props-和监听事件)
- [14. 💻 demos.4 - `<keep-alive>` - 基本用法](#14--demos4---keep-alive---基本用法)
- [15. 💻 demos.5 - `<keep-alive>` - include / exclude / max](#15--demos5---keep-alive---include--exclude--max)
- [16. 💻 demos.6 - `<keep-alive>` - onActivated / onDeactivated 生命周期](#16--demos6---keep-alive---onactivated--ondeactivated-生命周期)
- [17. 💻 demos.x - xxx](#17--demosx---xxx)
- [18. 💻 demos.x - xxx](#18--demosx---xxx)
- [19. 🔗 引用](#19--引用)
...
### 9.2. keep-alive 提供的三个 props：`include`、`exclude`、`max`
...
### 9.4. 配合 `<component>` 和 Vue Router 使用
...
## 11. 💻 demos.1 - `<component>` - 基本用法：标签页切换
...
## 12. 💻 demos.2 - `<component>` - 实现动态 HTML 元素
...
## 13. 💻 demos.3 - `<component>` - 传递 props 和监听事件
...
## 15. 💻 demos.5 - `<keep-alive>` - include / exclude / max
...
## 16. 💻 demos.6 - `<keep-alive>` - onActivated / onDeactivated 生命周期
